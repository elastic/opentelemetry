...
While the [{{edot}} (EDOT)](/reference/index.md) provides a streamlined experience with pre-configured components, you can also use the upstream OpenTelemetry Collector to send data to Elastic Observability. This approach requires more configuration but gives you full control over your OpenTelemetry setup.
