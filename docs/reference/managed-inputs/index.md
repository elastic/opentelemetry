...
| [Managed Vercel endpoint](https://www.elastic.co/docs/reference/integrations/vercel) | JSON or NDJSON | Ingest Vercel logs, audit logs, Web Analytics, and Speed Insights to {{es}} |
