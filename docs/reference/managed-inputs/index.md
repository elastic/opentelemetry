...
| [Managed Vercel endpoint](https://www.elastic.co/docs/reference/integrations/vercel) | OpenTelemetry Protocol (OTLP) | Ingest Vercel logs, audit logs, Web Analytics, and Speed Insights to {{es}} |
| [Managed Supabase endpoint](https://www.elastic.co/docs/reference/integrations/supabase) | OpenTelemetry Protocol (OTLP) | Ingest Supabase logs using the OpenTelemetry |
