...
## Migration steps [python-migration-migration-steps]
...
## Configuration mapping [python-migration-configuration-mapping]

The following are Elastic APM Python agent settings that you can migrate to EDOT Python.

### `api_key` [python-migration-api-key]
...
### `enabled` [python-migration-enabled]
...
### `environment` [python-migration-environment]
...
### `global_labels` [python-migration-global-labels]
...
### `secret_token` [python-migration-secret-token]
...
### `server_url` [python-migration-server-url]
...
### `service_name` [python-migration-service-name]
...
### `service_version` [python-migration-service-version]
...
## Limitations [python-migration-limitations]

The following limitations apply when migrating to EDOT Python.

### Central and dynamic configuration [python-migration-central-and-dynamic-configuration]
...
### Missing instrumentations [python-migration-missing-instrumentations]
...
### Span compression [python-migration-span-compression]
...
### Breakdown metrics [python-migration-breakdown-metrics]
...
## Troubleshooting [python-migration-troubleshooting]
