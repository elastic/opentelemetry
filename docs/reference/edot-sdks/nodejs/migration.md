...
If you're encountering issues during migration, refer to the [EDOT Node.js troubleshooting guide](docs-content://troubleshoot/opentelemetry/edot-sdks/nodejs/index.md).