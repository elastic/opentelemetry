...
:::{note}
For a broader overview of known limitations — including technical constraints related to PHP runtime and extensions, refer to [Limitations](./setup/limitations.md).
:::