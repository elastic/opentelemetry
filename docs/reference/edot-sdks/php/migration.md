...
If you're encountering issues during migration, refer to the [EDOT PHP troubleshooting guide](docs-content://troubleshoot/opentelemetry/edot-sdks/php/index.md).