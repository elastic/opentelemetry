...
- [Instrumenting Java](../../edot-sdks/java/setup/index.md/k8s)
- [Instrumenting Python](../../edot-sdks/python/setup/k8s.md)
- [Instrumenting Node.js](../../edot-sdks/nodejs/setup/index.md/k8s)
