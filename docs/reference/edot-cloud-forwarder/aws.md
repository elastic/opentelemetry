...
1. Navigate to [Launch Stack (S3 logs)](https://console.aws.amazon.com/cloudformation/home?#/stacks/new?templateURL=https://edot-cloud-forwarder.s3.amazonaws.com/v0/latest/cloudformation/s3_logs-cloudformation.yaml) to open the AWS CloudFormation console with the template automatically loaded.
