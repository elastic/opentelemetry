...
| ----------------------------------------------------------------------------------------------------------------------------- | ----------------------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OTEL_EXPORTER_OTLP_ENDPOINT](https://opentelemetry.io/docs/languages/sdk-configuration/general/#otel_exporter_otlp_endpoint) | http://localhost:4318   | URL                                             | Specifies the OTLP endpoint to which telemetry data should be sent.                                                                                                                                        |
| [OTEL_EXPORTER_OTLP_HEADERS](https://opentelemetry.io/docs/languages/sdk-configuration/general/#otel_exporter_otlp_headers)   |                         | string of key-value pairs                       | Key-value pairs to be used as headers (e.g., for authentication) when sending telemetry data via OTLP. Format: `key1=value1,key2=value2`.                                                                  |
...
| [OTEL_LOG_LEVEL](https://opentelemetry.io/docs/languages/sdk-configuration/general/#otel_log_level)                           | "info"                  | "error", "warn", "info", "debug"                | Sets the verbosity level of the OpenTelemetry SDK’s internal logging. Useful for debugging configuration or troubleshooting instrumentation.                                                               |
